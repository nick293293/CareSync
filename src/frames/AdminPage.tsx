  ...
  import { Box, Heading, Text, Button, Flex, Stack, Input, Spinner } from "@chakra-ui/react";
  import { useNavigate } from "react-router-dom";
  import { jsPDF } from "jspdf"; // Import jsPDF
  import "jspdf-autotable"; // Required for PDF table formatting
  ...
  const generateReport = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Format the PDF using a table layout
        doc.autoTable({
          head: [["ID", "Name", "DOB", "Phone"]],
